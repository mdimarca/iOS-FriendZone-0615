...
@interface LikesViewController ()<UICollectionViewDelegate, UICollectionViewDataSource>
...
- (void)viewDidLoad {
    ...
    [self.likesCollectionView registerClass:[UICollectionViewCell class] forCellWithReuseIdentifier:reuseIdentifier];
...
//    likesViewCell.likeText.text = @"HELLO";
